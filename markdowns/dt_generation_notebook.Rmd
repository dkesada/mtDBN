...
for(i in 1:n_cycles){
  ...
  params <- list(A_2 = 0.01, A_3 = 0.52e2, A_3_p = 0.52e2, A_4 = 0.08, 
               ...
               m_c = decide_policy(runif(1, 0, 5)), t_min = 800, t_max = 1300, vol = 20,
               delta_p = 12e5, mu_1 = 30, l = 1, Tin = 50, r = 0.019, A_6 = 0.1, Q_in = 70)
